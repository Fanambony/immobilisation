...
public class ClientTraitPurchaseOrderServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ArticleOrder> articleOrders = (List<ArticleOrder>) GenericDAO.directQuery(ArticleOrder.class, "SELECT * FROM article_quantity_order WHERE id_purchase_order = "+purchaseOrderClient.getIdPurchaseOrderClient(), null);
