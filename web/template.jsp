                            ...
                            <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown"
                               aria-expanded="false">
                                <div class="nav-profile-img">
                                    <img src="assets/photo_identity/<%= utilisateur.getPhoto() %>" alt="image">
                                    <span class="availability-status online"></span>
                                </div>
                                <div class="nav-profile-text">
                                    <p class="mb-1 text-black"><%= utilisateur.getUsername() %></p>
                                </div>
                            </a>
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <nav class="sidebar sidebar-offcanvas" id="sidebar">
                    <ul class="nav">
                        <li class="nav-item nav-profile">
                            <a href="#" class="nav-link">
                                <div class="nav-profile-image">
                                    <img src="assets/photo_identity/<%= utilisateur.getPhoto() %>" alt="profile">
                                    <span class="login-status online"></span>
                                    <!--change to offline or busy as needed-->
                                </div>
                                <div class="nav-profile-text d-flex flex-column">
                                    <span class="font-weight-bold mb-2"><%= utilisateur.getUsername() %></span>
                                    <span class="text-secondary text-small"><%= utilisateur.getService().getService() %></span>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="./etat-stock">
                                <span class="menu-title">Etat stock</span>
                                <i class="mdi mdi-buffer menu-icon"></i>
                            </a>
                        </li>
                        <% } %>
