                ...
                <table class="table mt-5">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right"><%= purchaseOrderClient.getArticleOrder().get(i).getTvaAmountString() %></td>
                            <td class="text-right"><%= purchaseOrderClient.getArticleOrder().get(i).getHtAmountString() %></td>
                            <td class="text-right"><%= purchaseOrderClient.getArticleOrder().get(i).getTtcAmountString() %></td>
                        </tr>
                        <% } %>
