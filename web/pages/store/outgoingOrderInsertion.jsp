                    ...
                    <div class="col-md-6">
                        ...
                        <form action="./outgoing-order-insertion" method="POST" class="forms-sample">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="responsableName" value="George MANANTENA" class="form-control" id="exampleInputUsername1" required="">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputUsername1">Contact responsable</label>
                                <input type="text" value="+261 12 453 25" name="responsableContact" class="form-control"
                                       id="exampleInputUsername1" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputUsername1">Motif du sortie</label>
                                <input type="text" name="motif" value="Vente" class="form-control"
                                       id="exampleInputUsername1" required>
                            </div>
