...
-- Reception --> Entry
CREATE SEQUENCE seq_supplier_delivery_order;
...
CREATE SEQUENCE seq_supplier_delivery_details;
...
CREATE SEQUENCE seq_reception_order;
...
CREATE SEQUENCE seq_reception_article_details;
...
CREATE SEQUENCE seq_entry_order;
...
CREATE SEQUENCE seq_entry_order_article;
...
CREATE SEQUENCE seq_dept_reception;
...
CREATE SEQUENCE seq_dept_reception_article;
...
VALUES
('INC0001', '10-12-2023', NULL, 1, 100, 400, NULL, 1),  
('INC0002', '10-12-2023', NULL, 2, 50, 600, NULL, 1),  
('INC0003', '10-12-2023', NULL, 3, 50, 3000, NULL, 1),  
('INC0004', '10-12-2023', NULL, 4, 70, 3200, NULL, 1);

INSERT INTO incoming 
(id_incoming, date, id_bde, id_article, quantity, unit_price, current_unit_price, etat)   
VALUES
('INC0005', '10-12-2023', NULL, 3, 10, 4000, NULL, 1);
